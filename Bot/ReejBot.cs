    ...
    internal class ReejBot : Bot
    {
        ...
        public IEnumerable<Action> OnFrame()
        {
            ...
            if (Controller.frame == Controller.SecsToFrames(1))
                Controller.Chat("I would love to suck huge dirty balls");
                Controller.Chat("God please help im stucked in damn CHDTU");
            ...
            foreach (var rc in resourceCenters)
            {
                ...
                {
                    rc.Train(Units.ORBITAL_COMMAND);
                    continue;
                }
